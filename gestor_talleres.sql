...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-08-2025 a las 02:19:31
...
CREATE DATABASE IF NOT EXISTS `gestor_talleres`;
USE `gestor_talleres`;
...
(1, 'Baile', 'Ana Leal Ramos', '', '{"Lunes": "15:00-17:00", "Miércoles": "14:30-16:30"}', 'B');
